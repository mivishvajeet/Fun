            ...
            case 'IcosahedronGeometry':
                if (currentcolor == 0xF66120) {
                    if (planetViewed == 0) {
                        ...
                        info.innerHTML = "I'm <span>Vishvajeet</span>  Dhawale,";
                        subtitle.innerHTML = "a <span>front-end developer</span> from Nanded.";
                        description.innerHTML = "I'm about to complete my B.tech, and I'm currently studying at <span>IIIT-A.</span><br/><br/><div>Click on the other planets to learn more ...<div>";
                    }
                ...
                if (currentcolor == 0x26D7E7) {
                    if (planetViewed == 1 || planetViewed==3 || planetViewed==4) {
                        planetViewed = 2;
                        info.innerHTML = '<span id="couleur">Github</span> Projects ';
                        document.getElementById('couleur').style.color="#26D7E7";
                        subtitle.innerHTML = "Since <span>October 2018</span>.";
                        description.innerHTML = "You can find all my projects here :  <br/><a target='_blank' href='https://github.com/mivishvajeet'>my Github</a><br/><br/><div>Click on the other planets to learn more ...<div>";
                   ...
                   if (currentcolor == 0xffc12d) {
                    if (planetViewed == 1 || planetViewed==2 || planetViewed==4) {
                        planetViewed = 3;
                        info.innerHTML = '<span id="couleur">Study</span> Project : <a target="_blank" href="https://mivishvajeet.github.io/swadd" style="font-size: 22px; color: white;">Swadd<a> ';
                         document.getElementById('couleur').style.color="#ffc12d";
                        subtitle.innerHTML = "Since <span>Nov 2018</span>.";
                        description.innerHTML = "Creating Food delivery site.<br/><br/><div>Click on the other planets to learn more ...<div>";
                    ...
                    if (planetViewed == 1 || planetViewed==2 || planetViewed==3) {
                        planetViewed = 4;
                        info.innerHTML = '<span id="couleur">Study</span> Project <div>: Blockchain<div> ';
                         document.getElementById('couleur').style.color="#acacac";
                        subtitle.innerHTML = "From <span>October 2018</span> To <span>Nov 2018</span> .";
                        description.innerHTML = "Bitcoins and Blockchain the buzzwords of the year <a target='_blank' href='https://mivishvajeetq.quora.com/'>Cypto</a> <br/><br/><div>Click on the other planets to learn more ...<div>";
